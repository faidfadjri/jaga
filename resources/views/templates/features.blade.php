    ...
    <div class="row align-items-center flex-grow-1 px-5 mb-5">
        <div class="col-sm-12 col-lg-6 d-flex flex-column gap-4">
            ...
            <p class="paragpraph opacity-60">
                ...
                mengantisipasi dan melawan kejahatan. Dengan teknologi canggih, JAGA mengidentifikasi dan memantau
                individu yang memiliki riwayat kriminal, memberikan perlindungan ekstra bagi komunitas Anda.
            </p>
    ...
    <div class="row align-items-center flex-grow-1 px-5 feature-row">
        ...
        <div class="col-sm-12 col-lg-6 d-flex flex-column gap-4">
            ...
            <p class="paragpraph opacity-60">
                ...
                mencegah anda berhubungan sosial dengan para pelaku tindak kejahatan seperti penipuan atau lain
                sebagainya.
            </p>
            <a class="btn btn-primary px-5" style="width: fit-content">Baca Selengkapnya</a>
        </div>
    ...
    <div class="row align-items-center flex-grow-1 px-5 feature-row-right">
        <div class="col-sm-12 col-lg-6 d-flex flex-column gap-4">
            ...
            <p class="paragpraph opacity-60">
                ...
                Mengantisipasi
                tindakan kejahatan yang mungkin terjadi dari orang-orang sekitar anda
            </p>
            <a class="btn btn-primary px-5" style="width: fit-content">Baca Selengkapnya</a>
        </div>
        <div class="col-sm-12 col-lg-6 d-flex align-items-center justify-content-center">
    ...
    <div class="row align-items-center flex-grow-1 px-5 feature-row">
        ...
        <div class="col-sm-12 col-lg-6 d-flex flex-column gap-4">
            ...
            <p class="paragpraph opacity-60">
                ...
                anda temukan
                dengan menyertakan bukti berupa foto / video dan menginformasikan lokasi korban
            </p>
            <a class="btn btn-primary px-5" style="width: fit-content">Baca Selengkapnya</a>
        </div>
    </div>
